...
import { demoUserBooks } from "../data/demoData";

export function ProfilePage() {
  return (
    <div>
      <PageHeader eyebrow="Profile" title="parlor-reader" description="Cozy fantasy, emotional ratings, overly specific shelves, and enough private notes to count as a second diary." />
      <section className="cozy-card mb-5 grid gap-5 md:grid-cols-[160px_1fr]">
        ...
        <div>
          <h2 className="font-serif text-4xl font-bold">Shoug’s Book Parlor</h2>
          <p className="mt-3 leading-7 text-espresso/70 dark:text-cream/70">Favorite genres, public shelves, public bookcases, reviews, comments, reading goals, year in books, and badges live here.</p>
      ...
      <BookcaseShelf bookcase={defaultBookcases[1]} books={demoUserBooks.filter((item) => item.ownershipStatus === "Purchased / Physically Owned")} />
    </div>
  );
}
